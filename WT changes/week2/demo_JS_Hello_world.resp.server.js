...
if (a1 > 0 && 
	...
	+"					var start = Date.now(); \n"
	+"					var timingdata = ''; \n"
	+"					if (window.performance && JSON.stringify) { \n"
	+"						timingdata = '&start=' + start + '&pnow=' + window.performance.now() + '&timing=' + JSON.stringify(window.performance.timing);  \n"
	+"					} \n"
	+"					var dwelltime = 0; \n"
	...
	+"						navigator.sendBeacon(url, 'ip=" + user_id + "&dwell=' + dwelltime + '&url=' + window.location.href + timingdata); \n"
	+"					}); \n"
